...
import '../utils/MinigameViewFactory.dart';
...
class VotedPageState extends State<VotedPage> {
  ...
  StreamSubscription<void>? _minigameStartedSubscription;
  ...
  void didChangeDependencies() {
    ...
    _minigameStartedSubscription ??=
        context.read<VotedViewModel>().minigameStarted.listen((minigame) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if(context.read<VotedViewModel>().isAlive == true) {
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: MinigameViewFactory.createMinigameView(
                          minigame)));
            }
            else {
              Navigator.pushReplacement(
  ...
  void dispose() {
    ...
    _minigameStartedSubscription?.cancel();
    super.dispose();
  }
